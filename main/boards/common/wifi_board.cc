...
void WifiBoard::StartNetwork() {
    ...
    config.ssid_prefix = "Agora-Convo";
...
void WifiBoard::StartWifiConfigMode() {
    ...
    Application::GetInstance().Schedule([&wifi_manager]() {
        ...
        Application::GetInstance().Alert(Lang::Strings::WIFI_CONFIG_MODE, hint.c_str(), "thinking", Lang::Sounds::OGG_WIFICONFIG);
    });
...
void WifiBoard::EnterWifiConfigMode() {
    ...
    if (state == kDeviceStateSpeaking || state == kDeviceStateListening || state == kDeviceStateIdle) {
        // Stop the active Sentino/Agora conversation before switching to config mode.
        Application::GetInstance().ResetConversationSession();
