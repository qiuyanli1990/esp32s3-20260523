...
class CustomLcdDisplay : public SpiLcdDisplay {
    public:
        ...
        virtual void SetupUI() override {
            ...
            // Keep the subtitle inside the round LCD safe area.
            lv_obj_set_width(bottom_bar_, LV_HOR_RES * 0.74);
            lv_obj_set_style_pad_bottom(bottom_bar_, 0, 0);
            lv_obj_align(bottom_bar_, LV_ALIGN_BOTTOM_MID, 0, -34);
            lv_obj_set_width(chat_message_label_, LV_HOR_RES * 0.66);
...
private:
        ...
        const esp_console_cmd_t cmd6 = {
            ...
            .func_w_context = [](void *context,int argc, char** argv) -> int {
                ...
                const char* region = "UNKNOWN";
                    ...
                    region = "KR";
                #endif
                printf("{\"type\":0,\"name\":\"VER?\",\"code\":0,\"data\":{\"software\":\"%s\",\"hardware\":\"watcher esp32s3-20260523\",\"camera\":%d,\"region\":\"%s\"}}\n",
                       app_desc->version,
    ...
    void InitializeCamera() {
        ESP_LOGI(TAG, "SSCMA camera disabled");
        camera_ = nullptr;
    }
