...
private:
    ...
    bool video_streaming_ = false;
    TaskHandle_t video_stream_task_handle_ = nullptr;
    VideoStreamCallback video_stream_callback_;
...
public:
    ...
    virtual void SetSessionActive(bool active) override;
    virtual bool StartVideoStream(VideoStreamCallback callback) override;
