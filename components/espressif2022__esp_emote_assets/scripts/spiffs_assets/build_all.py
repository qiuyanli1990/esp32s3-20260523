...
def build_assets(text_font, resolution_name, emoji_collection, wakenet_model=None, build_dir=None, final_dir=None, output_filename=None, name_length=None, external_base=None, extra_emoji_dirs=None):
    ...
    for extra_emoji_dir in extra_emoji_dirs or []:
        cmd.extend(["--extra_emoji_dir", extra_emoji_dir])
...
def main():
    ...
    for resolution_name in resolutions:
        ...
        if build_assets(text_font, resolution_name, emoji_collection, wakenet_model, build_dir, final_dir,
                        output_filename, args.name_length, external_base, args.extra_emoji_dir):
            successful_builds += 1
